...
locals {
  ...
  defined_tags  = merge(coalesce(var.defined_tags, {}), var.create_tags ? { "${var.tag_namespace}.role" = "worker" } : {})
  freeform_tags = merge(coalesce(var.freeform_tags, {}), !var.create_tags ? { "role" = "worker" } : {})
