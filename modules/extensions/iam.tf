...
locals {
  create_operator_dynamic_group_policy = (coalesce(var.cluster_kms_key_id, "none") != "none" && var.create_policies == true && var.create_bastion_host == true && var.enable_operator_instance_principal == true)
}
